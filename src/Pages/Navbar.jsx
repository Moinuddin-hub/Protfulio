...
export function Navbar() {
  ...
  return (
   <section className='fixed w-full  bg-red-500 z-50'>
     <div className="relative w-full h-20 bg-red-400">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
		...
		<img alt="" className="w-12 h-12 rounded-full ri ri dark:bg-gray-500 ri ri" src="https://source.unsplash.com/40x40/?portrait?1" />
          <span className="font-bold ">MOIN UDDIN</span>
        </div>
        <div className="hidden lg:block">
          <ul className="inline-flex space-x-8 text-2xl mt-2">
            {menuItems.map((item) => (
              <li key={item.name} >
                <a
                  href={item.href}
